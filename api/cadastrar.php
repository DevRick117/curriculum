...
<body>
    <form action="post" enctype="multipart/form-data">
        ...
        <input type="file" name="pic" accept="imagem/*" class="form-control">
    ...
    <form action="cadastro.php" method="post">
        ...
        <?php 
            error_reporting(0);
            $ext = strtolower(substr($_FILES['pic']['name'],-4)); //pegando extensao d arquivo
            $new_name = date("Y.m.d-H.i.s") . $ext; //definindo novo nome
            $dir = "./perfil/"; //dieretorio de uploud
