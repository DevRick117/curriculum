<?php 
    ...
    if(mysqli_query( $connect, $altcomp)){

    } else{
        echo "Atualização falhou; ".mysqli_error($$connect);
    }
    ...
    if(mysqli_query( $connect,$altexp))
    ...
    if(mysqli_query( $connect,$altimg))
    ...
    if(mysqli_query( $connect,$altper))
